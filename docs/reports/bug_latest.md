...
남은 것은 '낮음' 14건·'정보' 1건입니다. ⚠ 다만 아래 완전성 비평이 지적하듯 **BUG-11·BUG-12
는 금액 기준으로만 '낮음'** 이고(402 Guard 가 검증하지 않은 것을 "확인했다"고 기록하는 자리)
심사 신뢰도 관점에서는 먼저 볼 값어치가 있습니다 — "낮음이니 전부 안전"으로 읽지 마세요.
